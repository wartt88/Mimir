        ...
        <div className="bg-white flex rounded-lg shadow border px-10 py-5">
            ...
            {type === "friend" ?
                <div className="flex flex-row items-center space-x-5">
                    ...
                    <Image alt="" className="h-fit self-center cursor-pointer" height={32} onClick={removeFriend}
                ...
                <div className="flex flex-row items-center space-x-5">
                    ...
                    <Image alt="" className="h-fit self-center cursor-pointer" height={32} onClick={addFriend}
                           src="/addBlack.svg"
                           width={32}/>
                </div>
            }
